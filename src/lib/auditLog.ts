...
export const ACTION_LABELS: Record<string, string> = {
  ...
  cloud_backup_uploaded: "Backup uploaded to cloud storage",
  cloud_backup_failed: "Cloud backup upload failed",
  cloud_backup_connected: "Cloud backup storage connected",
  cloud_backup_disconnected: "Cloud backup storage disconnected",
